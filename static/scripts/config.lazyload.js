...
var MODULE_CONFIG = {
    ...
    screenfull:     [
                      '/static/libs/jquery/screenfull/dist/screenfull.min.js'
                    ],
    sortable:       [
    ...
    parsley:        [
                      '/static/libs/jquery/parsleyjs/dist/parsley.css',
                      '/static/libs/jquery/parsleyjs/dist/parsley.min.js'
                    ],
    select2:        [
                      '/static/libs/jquery/select2/dist/css/select2.min.css',
                      '/static/libs/jquery/select2-bootstrap-theme/dist/select2-bootstrap.min.css',
                      '/static/libs/jquery/select2-bootstrap-theme/dist/select2-bootstrap.4.css',
                      '/static/libs/jquery/select2/dist/js/select2.min.js'
                    ],
    datetimepicker: [
                      '/static/libs/jquery/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css',
                      '/static/libs/jquery/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.dark.css',
                      '/static/libs/js/moment/moment.js',
                      '/static/libs/jquery/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js'
                    ],
    chart:          [
    ...
    bootstrapWizard:[
                      '/static/libs/jquery/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js'
                    ],
    fullCalendar:   [
    ...
    dropzone:       [
                      '/static/libs/js/dropzone/dist/min/dropzone.min.js',
                      '/static/libs/js/dropzone/dist/min/dropzone.min.css'
                    ]
  };
